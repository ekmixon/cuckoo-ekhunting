...
class Machinery(object):
    ...
    def release(self, label=None):
        ...
        """
        return self.db.unlock_machine(label)
...
class AnalysisManager(threading.Thread):
    ...
    def set_target(self, targets):
        ...
        implemented analysis manager should decide how to handle/store this
        """
        raise NotImplementedError
    ...
    def build_options(self, options={}):
        ...
        @param options: dict. These are added to the default options."""
        default = {
        ...
        default["options"] = emit_options(task_options)

        self.options = default

    def wait_finish(self):
        """Wait until the analysis status is no longer running."""
    ...
    def action_requested(self):
        ...
        analysis manager requested action by the scheduler."""
    ...
    def init(self, db):
        ...
        manager thread is not started by the scheduler."""
        return True

    def run(self):
        """Logic to be executed when the analysis manager thread starts."""
        raise NotImplementedError
